...
def true_ord(char):
    ...
    # Just subtracting different offsets since we don't know where these
    # reside within the Unicode namespace
    if char.isdigit():
...
# Using multiplication to return a base-64 string to an integer
def saturate(key):
    """
...
# Using modulo and floor division to whittle down a big int into a base-64 string
